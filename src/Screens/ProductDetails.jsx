...
const ProductDetails = ({ setUrl, setCategory, setProduct, NAV_ITEMS }) => {
  const { id } = useParams();
  const uploadImg = useRef();
  const [action, setAction] = useState();
  //const navigate = useNavigateParams();
  const productInfo = product(id, NAV_ITEMS);
  ...
  }, [productInfo, setProduct, setCategory, NAV_ITEMS]);
  useEffect(() => {
        ...
        <>
          ...
          >
            <VStack
              ...
              minW={{ lg: '500px' }}
              spacing={
                productInfo.inquiry ? '10px' : { base: '30px', lg: '40px' }
              }
              minH={'600px'}
            >
              ...
              <Flex
                ...
                w="full"
                justifyContent={
                  productInfo.inquiry ? 'flex-start' : 'space-evenly'
                }
